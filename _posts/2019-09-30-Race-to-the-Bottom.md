...
First and foremost, to borrow a tired platitude, we can only manage what we can measure. California, and regions worldwide that seek to curb unsustainable groundwater use need to leverage [low-cost, remote sensor networks](http://ucwater.org/gw_obs) to monitor groundwater resources in near-real time. New well permits should come conditional with smart meters that measure water extraction and enable the creation of [groundwater markets](https://www.ppic.org/publication/californias-water-market/).  
