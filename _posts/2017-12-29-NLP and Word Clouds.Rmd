...
I recently came across the `tidytext` package in R, with the accompanying book: [Text Miniing in R](https://www.tidytextmining.com/) by David Robinson and Julia Silge. I found it very cogent and practical for basic text mining and NLP problems.  
